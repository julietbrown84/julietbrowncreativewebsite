                ...
                <div className="section-container section-container__container"> 
                    ...
                    <section className="content__row active">
                          <div className="row fullWidth">
                              <div className="large-12 columns text-center">
                                  <div className="section-container__large-image">
                    ...
                    <div className="row">
                      <div className="small-2 large-4 columns">
                            <div className="large-12 columns text-center">
                                <div className="section-container__artwork-one">
                      ...
                      <div className="small-2 large-4 columns">
                        <div className="large-12 columns text-center">
                            <div className="section-container__artwork-two">
                      ...
                      <div className="small-2 large-4 columns">
                          <div className="large-12 columns text-center">
                              <div className="section-container__artwork-three">
